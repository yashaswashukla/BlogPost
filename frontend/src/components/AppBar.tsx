      ...
      <div className="fixed top-0 left-0 w-full border-b border-slate-200  px-20 py-2 bg-white z-10 flex justify-between">
        ...
        <div className="flex gap-x-6">
          {publish && (
            <button
              onClick={sendData}
              className="flex flex-col justify-center px-3 bg-green-500 rounded-full text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-500 transition ease-in-out duration-300 hover:scale-110 focus:scale-90 font-semibold"
            >
              {label}
            </button>
          )}
